                        ...
                        for t in pdf_text:
                            try:
                                ...
                                if intersection_2 >= float(configur['PARAMS']['percent_val']):
                                    t['label'] = data['label']
                                    #print(data['label'])
                                    if data['label'] in ["declared_value_of_custom", "declared_value_of_carriage", "amount_insurance", "stamped_onboard_date", "carriage_condition", "shipment_date", "master_name"]:
                                        # exit('*****************exited')
                                        pass
                            except:
                                pass
