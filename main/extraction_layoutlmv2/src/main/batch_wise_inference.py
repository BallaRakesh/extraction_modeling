...
test_dataloader1 = DataLoader(train_dataset, batch_size=3)

for batch in tqdm(test_dataloader1, desc="Evaluating"):
    with torch.no_grad(): 
        ...
        with open('/home/ntlpt19/Downloads/Final_Delivery_Training_itter_2/testing_finetuning/PI/pi_model/classes.txt', "r") as f:
            labels = eval(f.read())
        f.close()
        ...
        image_png = Image.open('/home/ntlpt19/Downloads/Final_Delivery_Training_itter_2/testing_finetuning/PI/testing_images/Images/Proforma_Invoice(2013_01_10_13_51_15_4180)_493_0.png')
        ...
        print("+++++++++++++++++++reached here+++++++++++++++++")
        # exit("+++++++++")
        with open(os.path.join("/home/ntlpt19/Downloads/Final_Delivery_Training_itter_2/testing_finetuning/PI/testing_out_put/model_output.txt"), "w") as f:
