        ...
        if key in vertical_merge_labels:
            ...
            if length > 1:
                ...
                while i in range(length - 1):
                    ...
                    confs = [all_values[i][2], all_values[i + 1][2]]
                    min_dist_horizontal = check_vertical_distribution(bb1, bb2)
                    ...
                    if (bb1_height >= bb1_width and bb2_height >= bb2_width) or (bb1_height <= bb1_width and bb2_height <= bb2_width):
                        ...
                        if (min_dist_horizontal <= eps_horizontal or IOU_horizontal > 0 or inter_percentage>0) and (min_dist_vertical <= eps_vertical or IOU_vertical > 0 or inter_percentage):
                            print('min_dist_horizontal', min_dist_horizontal)
