...
miscellenous_fields = ["sum_insured_amount", "sum_insured_currency"]
                                ...
                                'invoice_discount_amount', 'invoice_tax_amount',\
                                    'premium_amount', 'total_amount_in_numeric', \
                                        'amount_due', 'advance_amount', 'total_amount_in_figure', 'tax_amount'
                                            "transaction_currency","transaction_amonunt_value",\
    "invoice_amount",
...
transport_fields : list = ['pre_carriage_by', 'mode_of_transport', 'means_of_transport',"pre-carriage-by",\
                    "mode_of_despatch",'pre_carriage_by', 'mode_of_dispatch']

number_fields :list = ['container_number']