...
# set_basic_config_for_logging(filename="hyper_parameter_tuning")
...
def objective(trial, labels, device, training_loss, validation_loss, itter, all_labels): #hyper
    import torch
    itter+=1
...
study.optimize(lambda trial: objective(trial, labels, device, training_loss, validation_loss, itter, all_labels), n_trials=50)
