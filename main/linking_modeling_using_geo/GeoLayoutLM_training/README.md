# Training GeoLayoutLM For Linking
- No need to make any changes to the code.
- Linking is automatically trained; just ensure that you have included the linking in the data preparation.
- In the "Further Improvements" section of the inference code, we have mentioned how to maintain the annotation data with reference samples and its effects. Please refer to that. We need to maintain the same approach for training as well.

- sharing example for referace:
```
        {
            "box": [
                102,
