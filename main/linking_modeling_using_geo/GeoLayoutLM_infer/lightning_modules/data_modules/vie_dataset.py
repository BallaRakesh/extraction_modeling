...
import ast  # Use ast.literal_eval to safely parse the string to a dictionary
...
class VIEDataset(Dataset):
    ...
    def _getitem_geo(self, idx):
        ...
        # file_path = '/media/ntlpt19/5250315B5031474F/geo_code_gpu/Geo_original_code/funsd_data/testing_funsd/funsd_data_linking/funsd_data/20886202_28_idx_tagging_result.txt'
        # with open(file_path, 'r') as lb:
        #     class_content = lb.read()
        # lb.close()
        # class_content = ast.literal_eval(class_content) 
        # json_obj["parse"]["class"] = class_content
        ...
        #         processed_dict[key] = value.cpu().numpy()
        #     else:
        ...
        # with open('return_dict.json', 'w') as f:
