...
prompt_3_updated = f""" You are an expert in document key-value extraction. Document Language: Indonesian (Bahasa Indonesia). 
...
- remember to you are responsible is to only extract the key and values from the OCR
Note: Return the result in JSON format.
"""


start_time = time.time()
prediction = generate_responce(prompt_3)
end_time = time.time()
