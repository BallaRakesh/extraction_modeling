...
def run_model():
    #Qwen2.5
    model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/Qwen2.5-0.5B-200K.Q4_K_M.gguf'     #4bit
    # model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/Qwen2.5-0.5B-200K.Q5_K_M.gguf'   #5bit n_ctx=550
    model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/Qwen2.5-0.5B-200K.F16.gguf'      #16bit
    
    
    
    model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/qwen2.5-0.5b-instruct-q8_0.gguf'     #8bit #not working on 4.jpg
    ...
    # model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/qwen2.5-0.5b-instruct-q3_k_m.gguf' #3bit #n_ctx=1000 #prompt1_1
    # model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/qwen2.5-0.5b-instruct-q4_k_m.gguf' #4.jpg = prompt1_1, 1.png = prompt1                       #PROMPT FRIENDLY
    
    
    # model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/qwen2.5-1.5b-instruct-q2_k.gguf' #2bit #prompt1_1
    
    #Llama-3.2
    # model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/Llama-3.2-3B-Instruct-Q4_K_M.gguf'  #4bit ####working1 #n_ctx=800 #seed=63, top_k=40, top_p=0.7, temperature=0.5
    # model_path2 = '/media/ntlpt19/5250315B5031474F/quantize_models/Llama-3.2-1B.F16.gguf'             #16bit #not working
