...
def analyze_read():
    ...
    # subscription_key = os.environ["DOCUMENTINTELLIGENCE_API_KEY"]
    key = '19uCryHmGclfBGSKQMkiwfIKSbzCIMQqKv1tHBubgGWZGGjhu5gDJQQJ99BCACGhslBXJ3w3AAAFACOGblzb'#os.environ["VISION_KEY"]
    endpoint = 'https://idp-ocr-service.cognitiveservices.azure.com/'#os.environ["VISION_ENDPOINT"]

    document_intelligence_client = DocumentIntelligenceClient(endpoint=endpoint, credential=AzureKeyCredential(key))

    # Analyze a document at a URL:
    # formUrl = "https://raw.githubusercontent.com/Azure-Samples/cognitive-services-REST-api-samples/master/curl/form-recognizer/rest-api/read.png"
    formUrl = '/home/ntlpt19/TF_testing_EXT/dummy_responces/Illumifin_data/All_classes_images/BEA/1_page_1.png'
...
'''
subscription_key = '19uCryHmGclfBGSKQMkiwfIKSbzCIMQqKv1tHBubgGWZGGjhu5gDJQQJ99BCACGhslBXJ3w3AAAFACOGblzb'#os.environ["VISION_KEY"]
endpoint = 'https://idp-ocr-service.cognitiveservices.azure.com/'#os.environ["VISION_ENDPOINT"]
...
read_image_url = '/home/ntlpt19/TF_testing_EXT/dummy_responces/Illumifin_data/All_classes_images/BEA/1_page_1.png'
