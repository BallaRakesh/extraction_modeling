...
base_directory = '/home/data_science/geo_testing/Classification_root/LC_org/LC'

train_data_csv = '/home/data_science/geo_testing/Classification_root/LC_org/training_set_1.csv'
test_data_csv = '/home/data_science/geo_testing/Classification_root/LC_org/testing_set_1.csv'
...
# id2label, label2id, train_df, valid_df = get_train_test_df(base_directory)#, custom_split, train_data_file=train_data_csv, test_data_file = test_data_csv, custom_label2id=custom_label2id)
print(label2id)
